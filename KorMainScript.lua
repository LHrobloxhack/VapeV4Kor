--This Script Kor Made By LHrobloxhack
...
if not (getasset and requestfunc and queueteleport) then
	print("베이프는 당신의 실행기에 적합하지 않습니다")
	return
end

if shared.VapeExecuted then
	error("베이프는 이미 적용되었습니다")
	return
else
...
checkpublicrepo = function(id)
	...
	if not suc then
		...
		spawn(function()
			...
			textlabel.Text = "커스텀 묘듈 로딩 실패, Attempts : "..checkpublicreponum
...
ProfilesTextList = Profiles.CreateTextList({
	...
	["CustomFunction"] = function(obj, profilename) 
		...
		bindbkg.Visible = GuiLibrary["프로필"][profilename]["Keybind"] ~= ""
		bindbkg.Parent = obj
		...
		bindimg.Visible = (GuiLibrary["프로필"][profilename]["Keybind"] == "")
		...
		bindtext.Visible = (GuiLibrary["프로필"][profilename]["Keybind"] ~= "")
		local bindtext2 = Instance.new("TextLabel")
		bindtext2.Text = "사용하고 싶은 키를 입력"
